...
1. Below, we gather and process our data
...
2. Boxplots for the data to help identify influential points later on
```{r box, echo = FALSE, result='show'}
...
3. Below we fit a simple linear model
Figure 1
...
```{r p-testing, echo=FALSE, results='show'}
...
```{r model_without_ankle, echo = TRUE, results='show'}
...
```{r model_without_Chest_Knee_Biceps, echo = TRUE, results='show'}
...
```{r BMI_colinearity, echo = FALSE, results='show'}
...
# new data model includes age, weight, neck, abdomen, hip, thigh, forearm, wrist without the two high leverage points
...
newDF_x_no_lev = as.data.frame(cbind(Age_no_lev, Weight_no_lev, Neck_no_lev, Abdomen_no_lev, Hip_no_lev, Thigh_no_lev, 
...
train.lm_no_lev = lm(trainY_no_lev ~ Age_no_lev + Weight_no_lev + Neck_no_lev + Abdomen_no_lev + Hip_no_lev + Thigh_no_lev + Forearm_no_lev + 
                Wrist_no_lev, data=trainX_no_lev)
train.sum_no_lev = summary(train.lm_no_lev)
train.sum_no_lev

test.lm_no_lev = lm(testY_no_lev ~ Age_no_lev + Weight_no_lev + Neck_no_lev + Abdomen_no_lev + Hip_no_lev + Thigh_no_lev + Forearm_no_lev + 
